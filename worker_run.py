...
from constants import DEFAULT_PARAM_TEMPLATE, N_BENCHMARKS, N_SELECT, SECOND_DEF_TEMPLATE, THIRD_N_SELECT, THIRD_TEMPLATE, THIRD_N_BENCHMARKS, FINAL_N_BENCHMARKS, FINAL_N_SELECT, FINAL_TEMPLATE
...
if __name__ == "__main__":
    ...
    n_select = FINAL_N_SELECT
    n_benchmarks = FINAL_N_BENCHMARKS
